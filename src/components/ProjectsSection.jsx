      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted border border-border text-foreground text-xs font-mono mb-3.5">
            <Radio className="h-3.5 w-3.5 text-emerald-500 animate-pulse" /> projects_directory
          </span>
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
            Practical full-stack applications with live production URLs, payment gateway integrations, real-time messaging, and responsive UI.
          </p>

          {/* Quick Metrics Bar */}
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 mt-6 pt-4 border-t border-border/40 text-xs font-mono text-muted-foreground">
            <div className="flex items-center gap-2">
              <span className="flex h-2 w-2 rounded-full bg-emerald-500" />
              <span>Live Deployed Demos</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Production Cloud APIs</span>
            </div>
          </div>
        </motion.div>
